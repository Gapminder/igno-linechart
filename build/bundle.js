...
(function (factory) {
  ...
  */
  function linechart({measure_id = "", geo_id = "", data = [], svg, geoProps = {}, conceptProps = {}, reference_values = [], y_domain, titleText="", sourceText="", options = {}}){
  ...
  Promise.all(fetch_concept_props.concat(fetch_instructions)).then(result => {
    ...
    DOM.graphsDownloadAll = DOM.nav.append("div").attr("class", "dl-all").text("Download all").on("click", () => downloadAll());
